...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        view.addConstraints([
            NSLayoutConstraint(item: cameraView, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: 1, constant: 70),
            NSLayoutConstraint(item: cameraView, attribute: .bottom, relatedBy: .equal, toItem: view, attribute: .bottom, multiplier: 1, constant: -70),
